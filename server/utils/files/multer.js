  ...
  destination: function (_, __, cb) {
    const uploadOutput =
      process.env.NODE_ENV === "development"
        ...
        : path.resolve(process.env.STORAGE_DIR || path.resolve(__dirname, `../../storage`), "assets");
  ...
  destination: function (_, __, cb) {
    const uploadOutput =
      process.env.NODE_ENV === "development"
        ...
        : path.resolve(process.env.STORAGE_DIR || path.resolve(__dirname, `../../storage`), "assets/pfp");
    fs.mkdirSync(uploadOutput, { recursive: true });
    return cb(null, uploadOutput);
  },
