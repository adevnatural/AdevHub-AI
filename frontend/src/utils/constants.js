...
export const ONBOARDING_SURVEY_URL = "https://onboarding.Adev-AI.com";

export const AUTH_USER = "Adev-AI_user";
export const AUTH_TOKEN = "Adev-AI_authToken";
export const AUTH_TIMESTAMP = "Adev-AI_authTimestamp";
export const COMPLETE_QUESTIONNAIRE = "Adev-AI_completed_questionnaire";
export const SEEN_DOC_PIN_ALERT = "Adev-AI_pinned_document_alert";
export const SEEN_WATCH_ALERT = "Adev-AI_watched_document_alert";
export const LAST_VISITED_WORKSPACE = "Adev-AI_last_visited_workspace";
export const USER_PROMPT_INPUT_MAP = "Adev-AI_user_prompt_input_map";

export const APPEARANCE_SETTINGS = "Adev-AI_appearance_settings";
