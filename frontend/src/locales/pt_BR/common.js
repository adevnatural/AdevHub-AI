...
const TRANSLATIONS = {
  onboarding: {
    ...
    llm: {
      ...
      description:
        "Adev-AI funciona com vários provedores de LLM. Este será o serviço que lidará com os chats.",
    },
    userSetup: {
    ...
    survey: {
      title: "Bem-vindo ao Adev-AI",
      description: "Ajude-nos a melhorar o Adev-AI. Opcional.",
      email: "Qual seu email?",
      useCase: "Como você usará o Adev-AI?",
      useCaseWork: "Para trabalho",
      useCasePersonal: "Uso pessoal",
      useCaseOther: "Outro",
      comment: "Como você conheceu o Adev-AI?",
      commentPlaceholder:
    ...
    workspace: {
      ...
      description: "Crie seu primeiro workspace e comece a usar o Adev-AI.",
    },
  },
  common: {
  ...
  customization: {
    ...
    branding: {
      ...
      description: "Personalize sua instância do Adev-AI com sua marca.",
    },
    chat: {
      title: "Chat",
  ...
  transcription: {
    ...
    "warn-start":
      "Usar o modelo local whisper em máquinas com RAM ou CPU limitada pode travar o Adev-AI.",
  ...
  privacy: {
    ...
    description:
      "Configurações de como provedores terceiros e o Adev-AI lidam com seus dados.",
    llm: "Seleção de LLM",
  ...
  connectors: {
    ...
    upload: {
      ...
      "privacy-notice":
        "Esses arquivos são enviados ao processador local do Adev-AI. Não são compartilhados com terceiros.",
    },
    pinning: {
