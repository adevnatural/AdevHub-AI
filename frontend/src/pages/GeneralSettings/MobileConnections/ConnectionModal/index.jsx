...
import Logo from "@/media/logo/adev-ai-logo-blue.svg";
        ...
        <div className="flex w-full h-full justify-between p-[35px]">
          ...
          <div className="flex flex-col w-1/2 gap-y-[16px]">
            <p className="text-[#FFF] text-xl font-bold">
              Go mobile. Stay local. Adev-AI Mobile.
            </p>
            <p className="text-[#FFF] text-lg">
              Adev-AI for mobile allows you to connect to your workspace's
            ...
            <Link
              to="https://play.google.com/store/apps/details?id=com.Adev-AI"
              target="_blank"
            >
              <img
                src={GetOnGooglePlay}
