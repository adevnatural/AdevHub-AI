...
https://github.com/Mintplex-Labs/Adev-AI-embed/blob/main/README.md
-->
<script
  data-embed-id="${embed.uuid}"
  data-base-api-url="${serverHost}/api/embed"
  src="${scriptHost}/embed/Adev-AI-chat-widget.min.js">
</script>
<!-- Adev-AI (https://Adev-AI.com) -->
`;
}
  ...
  return (
    <div>
      <div className="flex flex-col mb-2">
        ...
        <a
          href="https://github.com/Mintplex-Labs/Adev-AI-embed/blob/main/README.md"
          target="_blank"
          rel="noreferrer"
