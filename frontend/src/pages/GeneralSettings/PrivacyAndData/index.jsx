      ...
      <div className="relative rounded-lg">
        ...
        <div className="flex flex-col items-left space-y-2">
          <p className="text-theme-text-secondary text-xs rounded-lg w-96">
            ...
            look on{" "}
            <a
              href="https://github.com/adevnatural/AsistenAI-Adev"
          ...
          <p className="text-theme-text-secondary text-xs rounded-lg w-96">
            ...
            so that we can continue to improve ADEVHUB-AI for you.{" "}
            <a
              href="mailto:support@adevhub-ai.com"
              className="underline text-blue-400"
              target="_blank"
              rel="noreferrer"
            >
              support@adevhub-ai.com
            </a>
            .
          </p>
        </div>
