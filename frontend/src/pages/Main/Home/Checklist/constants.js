...
export const CHECKLIST_UPDATED_EVENT = "Adev-AI_checklist_updated";
export const CHECKLIST_STORAGE_KEY = "Adev-AI_checklist_completed";
export const CHECKLIST_HIDDEN = "Adev-AI_checklist_dismissed";
