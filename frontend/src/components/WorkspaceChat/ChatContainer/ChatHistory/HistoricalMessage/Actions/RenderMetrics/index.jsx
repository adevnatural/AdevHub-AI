...
const SHOW_METRICS_KEY = "Adev-AI_show_chat_metrics";
const SHOW_METRICS_EVENT = "Adev-AI_show_metrics_change";
...
/**
 * Get the show metrics setting from localStorage `Adev-AI_show_chat_metrics` key
 * @returns {boolean}
 */
...
/**
 * Toggle the show metrics setting in localStorage `Adev-AI_show_chat_metrics` key
 * @returns {void}
 */
